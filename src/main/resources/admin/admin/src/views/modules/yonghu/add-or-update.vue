	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="消息通知" prop="msg">
					<el-input v-model="ruleForm.msg" placeholder="消息通知" clearable  :readonly="ro.msg"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="消息通知" prop="msg">
					<el-input v-model="ruleForm.msg" placeholder="消息通知" readonly></el-input>
				</el-form-item>
			</template>

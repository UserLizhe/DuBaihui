<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0 2px","position":"relative","background":"#f8f6f0"}' class="el-menu-vertical-demo" default-active="0">
	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","margin":"0 0 0 -2px","display":"none"}
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  color: #333;
				  				  white-space: nowrap;
				  				  background-image: url(http://codegen.caihongy.cn/20220727/3a8efa9cc83d453589d4952dddf62ea4.png);
				  				  position: relative;
				  				  text-align: center;
				  		}
		...
		.el-menu-vertical-demo>.el-menu-item:hover {
						...
						background-size: 100% 100%;
						color: #fff;
						background-image: url(http://codegen.caihongy.cn/20220727/b211f0ad86b045dcb04f75c37e91ce61.png);
					}

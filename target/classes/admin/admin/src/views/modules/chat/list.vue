    ...
    <div v-if="!showFlag" style="width: 100%;">
      <div>
        <el-table
          ...
          style="width: 100%;"
        >
          <el-table-column :resizable='true' :sortable='false' prop="ask" header-align="center" align="center" sortable label="新留言"></el-table-column>
          <el-table-column
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
				:style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"rgba(0, 0, 0, 1)","borderRadius":"30px","background":"rgba(228, 228, 228, 1)","width":"auto","fontSize":"14px","height":"32px"}'
                size="small"

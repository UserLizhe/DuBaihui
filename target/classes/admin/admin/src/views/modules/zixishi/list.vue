		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"top":"-140px","margin":"0 30px -130px 80px","position":"relative"}' :inline="true" :model="searchForm">
				...
				<el-row :style='{"margin":"20px 0","justifyContent":"flex-end","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#000","borderRadius":"4px","background":"rgba(228, 228, 228, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('zixishi','新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#000","borderRadius":"4px","background":"rgba(228, 228, 228, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('zixishi','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='false'  
						prop="shoufeishuoming"
					label="收费说明">
						<template slot-scope="scope">
							{{scope.row.shoufeishuoming}}
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='false'  
						prop="price"
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"rgba(0, 0, 0, 1)","borderRadius":"30px","background":"rgba(228, 228, 228, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('zixishi','查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"rgba(0, 0, 0, 1)","borderRadius":"30px","background":"rgba(228, 228, 228, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('zixishi','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>


							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"rgba(0, 0, 0, 1)","borderRadius":"30px","background":"rgba(228, 228, 228, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('zixishi','查看评论')" type="primary" size="mini" @click="disscussListHandler(scope.row.id)">查看评论</el-button>



							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"rgba(0, 0, 0, 1)","borderRadius":"30px","background":"rgba(228, 228, 228, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('zixishi','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination

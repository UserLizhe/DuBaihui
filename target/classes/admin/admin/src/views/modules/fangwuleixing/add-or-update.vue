<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="租金分类" prop="fangwuleixing">
					<el-input v-model="ruleForm.fangwuleixing" placeholder="租金分类" clearable  :readonly="ro.fangwuleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="租金分类" prop="fangwuleixing">
					<el-input v-model="ruleForm.fangwuleixing" placeholder="租金分类" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				fangwuleixing: [
					{ required: true, message: '租金分类不能为空', trigger: 'blur' },
				],
			}
		};
	},

...
<div :style='{"width":"1200px","padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"10px auto","position":"relative","background":"#fff"}'>
    <div class="section-title" :style='{"margin":"10px 0","borderColor":"#99DFE5","color":"#000","textAlign":"center","background":"linear-gradient(270deg, rgba(119,217,221,0) 0%, #77D9DD 47%, rgba(149,221,226,0) 100%)","borderWidth":"0 4px","fontSize":"20px","lineHeight":"54px","borderStyle":"solid"}'>留言反馈</div>
